...
All AI disabled. No AI Assistant, no agents,
...
AI Assistant in Query mode only. No agents,
...
AI Assistant in Query mode + passive background

agents (auto-triage, affiliation).
...
Full AI: Query mode, automation, and Aurelius

agent mode with all specialist agents.
