...
-   **Strict Tenant Boundaries**: AI operations are scoped to your data partition. The assistant cannot query, access, or reference data belonging to other tenants. Every databa
