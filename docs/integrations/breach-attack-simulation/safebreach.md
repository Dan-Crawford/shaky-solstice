---
title: "SafeBreach"
description: "SafeBreach"
featurebaseId: "0148736"
---
...
* Name the key (e.g., `PGP Integration`) and set permissions to **Read Only**
* Copy the generated API key and the **Account ID** displayed on the settings page
