...
7. Ensure the API client has **READ** access to the **Property Manager (PAPI)** API
...
1. Go to **Integrations, then Content Delivery Network, then Akamai CDN** in the Guard Platform

2. Enter your EdgeGrid credentials in the setup form

3. Click **Connect** — PGP will validate your credentials by attempting to fetch your properties before saving
