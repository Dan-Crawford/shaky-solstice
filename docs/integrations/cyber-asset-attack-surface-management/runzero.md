...
- Name the key (e.g., `PGP Integration`) and set the **Role** to **Read Only**
...
- In PGP, go to **Integrations** and locate **RunZero** (under Cyber Asset Attack Surface Management)
- Enter the required credentials
- Click **Connect** -- PGP will validate the API key before saving
