...
* **Zones** *(optional)* — If you want to limit the integration to specific domains, enter a comma-separated list of zone names (e.g., `example.com, app.example.com`). If left blank, PGP will apply the whitelist rule to all zones in your Cloudflare account.
