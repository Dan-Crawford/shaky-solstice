...
5. Search for and add `DeviceManagementManagedDevices.Read.All`.
...
2. Select **Azure** from the list of available integrations (Intune is included as part of the Azure integration).
3. Enter your Azure credentials in the configuration form.
4. Save the integration. PGP will validate connectivity to the Microsoft Graph API automatically, including access to the Intune device management endpoints.
