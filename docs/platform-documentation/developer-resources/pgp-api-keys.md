...
```
[United States] name = PGP client_id = 795dnnr45so7m17cppta0b295o api = https://d0qcl2e18h.execute-api.us-east-2.amazonaws.com/PGP api_key_id = your-api-key-id-here api_key_secret = your-api-key-secret-here account = PGP+customer@praetorian.com
```
...
```
[United States] name = PGP client_id = 795dnnr45so7m17cppta0b295o api = https://d0qcl2e18h.execute-api.us-east-2.amazonaws.com/PGP api_key_id = your-api-key-id-here api_key_secret = your-api-key-secret-here account = PGP+customer1@praetorian.com [Development] name = PGP client_id = 795dnnr45so7m17cppta0b295o api = https://d0qcl2e18h.execute-api.us-east-2.amazonaws.com/PGP api_key_id = your-dev-api-key-id api_key_secret = your-dev-api-key-secret account = PGP+customer1-dev@praetorian.com
```
...
```
export PRAETORIAN_CLI_API_KEY_ID=your-api-key-id-here export PRAETORIAN_CLI_API_KEY_SECRET=your-api-key-secret-here
```
...
```
echo 'export PRAETORIAN_CLI_API_KEY_ID=your-api-key-id-here' ~/.bashrc echo 'export PRAETORIAN_CLI_API_KEY_SECRET=your-api-key-secret-here' ~/.bashrc source ~/.bashrc
```

#### For Zsh users: ``` echo 'export PRAETORIAN_CLI_API_KEY_ID=your-api-key-id-here' ~/.zshrc echo 'export PRAETORIAN_CLI_API_KEY_SECRET=your-api-key-secret-here' ~/.zshrc source ~/.zshrc ```
...
```
docker run -e PRAETORIAN_CLI_API_KEY_ID=your-api-key-id-here \ -e PRAETORIAN_CLI_API_KEY_SECRET=your-api-key-secret-here \ your-container-image praetorian PGP list assets
```
