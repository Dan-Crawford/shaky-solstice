...
Full platform access. Can manage users, settings, integrations, and all data.

**Analyst**

Can create and modify assets, seeds, risks, run scans, upload files, and use AI features. Cannot manage users, settings, or integrations.

**Read Only**

View-only access to all data. Cannot create, modify, or delete anything.
...
View assets, risks, seeds, and jobs
...
Create/edit assets, seeds, and risks
...
Run scans and schedule capabilities
...
Configure integrations (Jira, Azure DevOps, etc.)
